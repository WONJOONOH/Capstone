...
### 2.3 간략한 작동 방식
```
https://github.com/gfdsa8/Capstone/blob/test/ppt%20%EC%82%AC%EC%A7%84/%ED%95%B5%EC%8B%AC%20%EA%B8%B0%EB%8A%A5%201.PNG?raw=true
- 바코드를 읽어서 해당 제품의 이름과 영양정보를 알아온다.
![핵심 기능2](PPT 사진/핵심 기능 2.PNG)
- 유통기한을 입력 받아서 해당 제품의 유통기한이 다가옴에 따라 알림을 보내는 기능을 수행한다.
![핵심 기능3](PPT 사진/핵심 기능 3.PNG)
